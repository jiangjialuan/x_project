<template>
  <div id="register" :style="focusing?'padding-bottom:'+winH+'px;':''">
    <top></top>
    <!--<div class="logo-box">
      <img class="logo-img" src="../../img/logo.png"/>
      <p class="logo-text">Register a new account</p>
    </div>-->
    <div class="form">
      <div class="yd-input">
        <div class="input-label">FULL NAME</div>
        <input  placeholder="please enter your full name" class="input-style" pattern="\d*" style="width:100%;"
               v-model="form.fullname" @focus="comfocus" @blur="comblur"/>
      </div>
      <div class="yd-input">
        <div class="input-label">MOBILE PHONE NUMBER</div>
        <input type="number" placeholder="please enter your mobile phone number" class="input-style" pattern="\d*" style="width:100%;"
      ...
      <div class="yd-input">
        ...
        <div class="input-style flex-row" style="justify-content: space-between">
          <input type="tel" placeholder="please enter the code" pattern="\d*" v-model="form.code" @focus="comfocus"
                 @blur="comblur"/>
      ...
      <div class="yd-input">
        <div class="input-label">SET A PASSWORD</div>
        <input type="password" placeholder="Password length is 6 to 12" class="input-style" pattern="\d*" style="width:100%;"
               v-model="form.password" @focus="comfocus" @blur="comblur"/>
      </div>

      <div class="flexBox">
        <mt-button class="login-button" @click.native="submit">REGISTER</mt-button>
      </div>
    </div>
  </div>
</template>
