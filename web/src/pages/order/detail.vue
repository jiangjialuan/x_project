      ...
      <div class="order-item order-data clearfix">
        <div class="order-info">
          ...
          <div class="inner form-box">
            <div class="group">
              <p class="item">
                <span class="label">兑换人：</span>{{formData.consignee}}
              </p>
              <p class="item">
                <span class="label">兑换时间：</span>{{formData.exchange_time||''}}
              </p>
            </div>
            <div class="group" >
              <p class="item">
                <span class="label">所需积分：</span>{{formData.use_points}}
              </p>
              <p class="item">
      ...
      <div class="goods-wrap">
        <table style="width:100%;" cellspacing="0" cellpadding="0" border="0" class="el-table el-table--border">
          ...
          <tr>
            ...
            <th class="is-leaf alignCenter"><div class="cell">所需积分</div></th>
          </tr>
          </thead>
          ...
          <tr>
            <td class="cell" colspan="6">
              <p>
                ...
                <span class=" right total-price">所需积分：<span class="icon-bean price">{{formData.use_points}}</span></span>
              </p>
            </td>
          </tr>
        </table>
